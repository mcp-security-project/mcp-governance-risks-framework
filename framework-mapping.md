...
| MCP02: Privilege Escalation via Scope Creep | [Ch. 3](mcp-governance-risk-framework-v1.0.md#principle-3-least-privilege-for-tools) (Principle 3), [Ch. 4 — Tool Definition Baseline](mcp-governance-risk-framework-v1.0.md#tool-definition-baseline-and-drift-handling), [Ch. 5](mcp-governance-risk-framework-v1.0.md#classification-rules) | Least privilege per tool; classify by highest-risk tool; re-classify when tools or approved definitions change materially |
| MCP03: Tool Poisoning | [Ch. 2 — Tool Definition Drift](mcp-governance-risk-framework-v1.0.md#tool-definition-drift-rug-pull), [Ch. 4 — Tool Definition Baseline](mcp-governance-risk-framework-v1.0.md#tool-definition-baseline-and-drift-handling), [Ch. 5](mcp-governance-risk-framework-v1.0.md#tier-decision-tree) | Deterministic definition baselines, drift detection, re-review, and tool chaining awareness |
...
| **CC8.1**: Change management | [Ch. 4 — Tool Definition Baseline](mcp-governance-risk-framework-v1.0.md#tool-definition-baseline-and-drift-handling), [Ch. 5 — Rule 2](mcp-governance-risk-framework-v1.0.md#rule-2-re-classify-when-tools-change) | Definition baselines, drift detection, re-review, re-classification, and version pinning |
