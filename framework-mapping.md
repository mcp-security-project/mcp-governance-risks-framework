...
|----------------|---------------|----------------|
| **CC6.1**: Logical access | [Appendix — Formal Control Catalog](mcp-governance-risk-framework-v1.0.md#formal-control-catalog) (MCP-03, MCP-04), [Appendix — Authorization Test Cases](mcp-governance-risk-framework-v1.0.md#authorization-test-cases) | Authentication, scoped authorization, resource, audience, and issuer validation |
